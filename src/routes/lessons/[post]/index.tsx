...
export default component$(() => {
  ...
  return (
    <div class='relative w-full max-w-6xl mx-auto mt-16 md:mt-32 flex gap-20 px-10 md:px-0'>
      ...
      <div class='w-full prose prose-headings:font-medium prose-h1:border-b-2 prose-h1:pb-6 prose-slate text-lg md:text-xl leading-loose'>
